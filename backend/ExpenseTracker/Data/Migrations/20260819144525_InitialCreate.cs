    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InsightId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AIInsights_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThresholdPercent = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false, defaultValue: 80.00m),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIInsights_UserId_GeneratedAt",
                table: "AIInsights",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Budgets_UserId_CategoryId_PeriodMonth_PeriodYear",
                table: "Budgets",
                columns: new[] { "UserId", "CategoryId", "PeriodMonth", "PeriodYear" },
                unique: true,
